...
INSERT INTO "new_BlogPost" ("author_id", "content", "created_at", "description", "id", "title", "updated_at") SELECT "author_id", "content", "created_at", "description", "id", "title", "updated_at" FROM "BlogPost";
DROP TABLE "BlogPost";
...
INSERT INTO "new_Comment" ("blog_post_id", "content", "created_at", "id", "parent_id", "user_id") SELECT "blog_post_id", "content", "created_at", "id", "parent_id", "user_id" FROM "Comment";
DROP TABLE "Comment";
...
INSERT INTO "new_Rating" ("blog_post_id", "comment_id", "id", "rating", "user_id") SELECT "blog_post_id", "comment_id", "id", "rating", "user_id" FROM "Rating";
DROP TABLE "Rating";
