...
INSERT INTO "new_Template" ("author_id", "code", "created_at", "description", "id", "numOfViews", "title", "updated_at") SELECT "author_id", "code", "created_at", "description", "id", "numOfViews", "title", "updated_at" FROM "Template";
DROP TABLE "Template";
